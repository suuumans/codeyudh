...
// Define types for the difficulty levels
...
// Define props for the ProblemCard component
    ...
    >
      <div className="p-4 flex flex-col h-full">
        <div className="flex justify-between items-start mb-3">
          <span
            className={`text-xs font-bold px-2 py-1 rounded-full text-white ${difficultyColors[problem.difficulty]}`}
          >
