...
interface SampleProblemSelectorProps {
  isOpen: boolean;
  onClose: () => void;
//   onSelectProblem: (problem: Problem) => void; // this is for the whole problem
  onSelectProblem: (id: string) => void; // this is just for the id
  problems: Problem[];
}

const SampleProblemSelector: React.FC<SampleProblemSelectorProps> = ({
  isOpen,
  onClose,
  onSelectProblem,
  problems,
