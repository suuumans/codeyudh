...
import { Play, FileText, MessageSquare, Lightbulb, Bookmark, Share2, Clock, ChevronRight, BookOpen, Terminal, Code2, Users, ThumbsUp, Home } from 'lucide-react';
...
const ProblemPage: React.FC = () => {
    ...
    useEffect(() => {
        if(problem) {
            ...
            setTestCases(problem.testcases?.map((testCase) => ({ input: testCase.input, output: testCase.output })) || [])
        }
    ...
    const renderTabContent = () => {
        ...
        case "submissions":
            return submissions && Array.isArray(submissions) ? (
        ...
        case "hints":
          return (
            <div className="p-4">
              {problem?.hints ? ( // Use the correct property name from your Problem type
        ...
        <div className="flex-1 gap-2">
          ...
          <div className="mt-2">
            ...
            <div className="flex items-center gap-2 text-sm text-base-content/70 mt-5">
              ...
              <span>Updated {problem.createdAt ? new Date(problem.createdAt).toLocaleString("en-US", {
                  year: "numeric",
                  month: "long",
                  day: "numeric",
                }) : "Unknown Date"}</span>
            ...
            {submission ? (
              <SubmissionResults
                submission={{
                  ...
                  testCases: (submission as any)?.testCases ?? [],
                }}
              />
            ) : (
              <>
