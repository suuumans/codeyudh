...
const SheetsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center mt-14 px-4 bg-base-200">
      <div className="w-full max-w-6xl mx-auto mt-4">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 text-base-content">Sheets (Curated Playlists)</h1>
          <p className="text-xl text-base-content/70 max-w-3xl mx-auto">
            Explore handpicked coding sheets to master key topics and ace interviews.
          </p>
        </header>
        {isLoading ? (
          ...
          <div className="space-y-6">
            {playlists.map((sheet: any) => (
              <div key={sheet.id} className="card bg-base-100 shadow-xl border border-base-300 rounded-xl overflow-hidden transition-all duration-300">
                <div className="card-body p-6">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-base-content">{sheet.name}</h3>
