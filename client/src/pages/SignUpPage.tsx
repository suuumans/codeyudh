...
import { signUpSchema, type SignUpSchemaType } from '../inputValidations/signUpValidation.ts'
  ...
  return (
    ...
    <div className="h-screen grid lg:grid-cols-2">
      ...
      <CodeBackground
        ...
        subtitle={
          "Join our community to access our platform and start using our services."
        }
      />
    </div>
  );
